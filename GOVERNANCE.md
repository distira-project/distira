...
| --- | --- |
| **Maintainers** | Merge PRs, cut releases, define roadmap priorities |
| **Reviewers** | Review PRs, triage issues, enforce code standards |
| **Contributors** | Submit PRs, report issues, improve documentation |
